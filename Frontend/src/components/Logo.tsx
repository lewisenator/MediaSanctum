  ...
  return (
    <svg className="h-7 w-7 shrink-0" viewBox="0 0 130 130" fill="none" aria-hidden="true">
      ...
      <path d="M44 40 V36 H50 V40 H56 V36 H62 V40 H68 V36 H74 V40 H80 V36 H86 V40 Z"
            fill="currentColor"/>
      <line x1="44" y1="44" x2="86" y2="44" stroke="currentColor" stroke-width="1"/>
      <rect x="48" y="44" width="34" height="64" stroke="currentColor"
            stroke-width="2" fill="currentColor" fill-opacity="0.04"/>
      ...
      <line x1="38" y1="116" x2="92" y2="116" stroke="currentColor" stroke-width="2"/>
    </svg>
  );
};
